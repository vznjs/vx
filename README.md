...
Fully cached runs finish in milliseconds: 510 ms across a
1,090-package graph of 3,270 tasks, where Turborepo takes 760ms and Nx
3.59s on the identical workspace, and a cold build of that graph burns
35 s of CPU in vx, 73 s in Turborepo and 114 minutes in Nx.
<!-- bench:end -->
