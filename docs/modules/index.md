...
| Wire / backend    | `optionsToRequest`, `requestToOptions`, `projectNode`, `projectOutcome`, `createWireRenderer`; types `RunBackend`, `RunRequest`, `RunResult`, `ClientMessage`, `ServerMessage`                                                                                                                                                                                                |
