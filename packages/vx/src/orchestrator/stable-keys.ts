...
export async function deriveStableKeys(args: DeriveStableKeysArgs): Promise<StableKey[]> {
  ...
  //     own dir), a bitset over project indexes: a union per dep was a
  //     string Set copied tasks × deps × projects times, 101 ms of a 513 ms
  //     warm run at 476 packages (item 743).
