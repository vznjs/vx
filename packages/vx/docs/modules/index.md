...
set (46 names) is pinned by the same test; widening it is a deliberate
...
| Migration           | `applyMigration`, `foldScriptHooks`, `PERSISTENT_TASK_NAMES`, `PERSISTENT_TODO`, `quoteTsLiteral`                                                                       | `ApplyMigrationArgs`, `MigrationFormat`, `GeneratedProject`, `GeneratedTask`, `MigrationPlan`, `RawExpr`                                                                                                                                                                                                                                                                                                                                                                                                                       |
