...
| Engine              | `run`, `planRun`, `prepareRun`, `splitTaskId`, `LocalHistoryProvider`                                                                                                   | `RunOptions`, `RunSummary`, `CachePolicy`, `Logger`, `OutputView`, `PreparedRun`, `RunPlan`, `PlannedTask`, `RunResult`, `TaskView`, `OutcomeView`, `TaskNode`, `TaskOutcome`, `TaskStatus`, `HistoryProvider`, `HistoryTable`, `TaskHistory`, `CiContext`, `GitContext`, `HostContext`, `WorkspaceIdentity`                                                                                                                                                                                                                   |
