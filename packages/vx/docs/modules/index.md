...
set (42 names) is pinned by the same test; widening it is a deliberate
...
| Engine              | `run`, `planRun`, `prepareRun`, `splitTaskId`, `LocalHistoryProvider`                                                                                                   | `RunOptions`, `RunSummary`, `CachePolicy`, `Logger`, `OutputView`, `PreparedRun`, `RunResult`, `TaskView`, `OutcomeView`, `TaskNode`, `TaskOutcome`, `TaskStatus`, `HistoryProvider`, `HistoryTable`, `TaskHistory`, `CiContext`, `GitContext`, `HostContext`, `WorkspaceIdentity`                                                                                                                                                                                                                                             |
