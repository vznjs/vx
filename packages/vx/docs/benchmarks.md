...
743 found the cost in vx's stable-key pass; after it, warm reads vx 0.35 s against Turbo 0.35 here (min of 9, interleaved), a tie.
...
Here too Turbo 2.11 won the warm columns. Item 743 found why: vx's
