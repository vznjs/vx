export function printHelp(): void {
  process.stdout.write(
    [
      ...
      '      --verify                    Prove cache correctness: re-run each executed cacheable task and',
      '                                  content-compare its outputs. A non-deterministic task (unsafe to',
      '                                  cache) fails the run with the diverging paths. ~2× exec; CI-shaped.',
