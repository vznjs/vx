export function printHelp(): void {
  process.stdout.write(
    [
      ...
      '  vx serve                 Foreground execution service. While it runs, every',
      '                           `vx run` in this workspace DELEGATES to it over a',
      '                           WebSocket (work happens server-side; output streams',
      '                           back and renders identically). No service running =',
      '                           runs execute in-process as before. Ctrl-C stops it.',
      '      --port <n>           Preferred port (default: an open one).',
      ...
      '  vx insights serve    Boot the local SPA + static cache.db server (read-only).',
      '      --port <n>       Preferred port for the SPA dev server (default 5290).',
