export function printHelp(): void {
  process.stdout.write(
    [
      ...
      '',
      'Execution service + dashboard:',
      '  The service layer (vx serve / dev / coordinator / worker, the /v1/* metrics',
      '  API, and the dashboard SPA) lives in the separate @vzn/vx-cloud package.',
      '  Install it for the `vx-cloud` binary; a plain `vx run` always executes',
      '  in-process and never requires it.',
      '',
