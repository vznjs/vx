export function printHelp(): void {
  process.stdout.write(
    [
      ...
      '',
      'Live devtools (for run — needs the optional `devframe` package):',
      '      --ui                 Serve a live devframe devtool (h3 + WebSocket) for the',
      '                           run; keeps serving after it finishes until Ctrl-C.',
