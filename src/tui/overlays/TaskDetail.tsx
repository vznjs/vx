// Task Detail overlay — Enter on the task list opens this. Shows
// static facts, recent run history, and a live-log tail.
...
export function TaskDetail({ state, width, height }: Props): React.ReactNode {
  void width
  ...
  const logTail = row.logLines.slice(-Math.max(3, height - 14))
