...
export interface RunOptions {
  ...
  command?: string
  /**
   * `--report` output format (Tier-3). `'markdown'` prints a run-report
   * table to stdout after the run. Generated by the CLI in Phase B3;
   * declared here so the option exists end-to-end.
   */
  report?: 'markdown'
}
